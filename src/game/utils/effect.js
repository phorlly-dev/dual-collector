...
import { success, warning } from "../consts/colors";
...
const Effects = {
    power({ scene, x, y, operation, value, oldPower }) {
        ...
        flashScreen({ scene: scene, color: 0x9b59b6, alpha: 0.3 });
    },
    score({ scene, x, y, operation, value, oldScore }) {
        ...
        flashScreen({ scene: scene, color: 0xe67e22, alpha: 0.2 });
    },
    bomb(scene, player) {
        // 1. Camera shake
...
export const { power, score, bomb } = Effects;
