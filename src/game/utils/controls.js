...
const createControls = (scene, isMobile) => {
    scene.leftBtn = scene.add
        .image(40, GAME_HEIGHT - 80, LOAD_ASSETS.KEY.LEFT)
        .setInteractive()
        .setScrollFactor(0)
    ...
    scene.rightBtn = scene.add
        .image(120, GAME_HEIGHT - 80, LOAD_ASSETS.KEY.RIGHT)
        .setInteractive()
        .setScrollFactor(0)
        .setAlpha(0.8)
        .setScale(0.1)
    ...
    scene.jumpBtn = scene.add
        .image(GAME_WIDTH - 100, GAME_HEIGHT - 80, LOAD_ASSETS.KEY.UP)
        .setInteractive()
        .setScrollFactor(0)
        .setAlpha(0.8)
        .setScale(0.1)
    ...
    scene.pauseBtn = scene.add
        .image(GAME_WIDTH - 40, GAME_HEIGHT - 80, LOAD_ASSETS.KEY.PAUSE)
        .setInteractive()
        .setScrollFactor(0)
        .setAlpha(0.8)
        .setScale(0.1);
    ...
    scene.playBtn = scene.add
        .image(GAME_WIDTH - 40, GAME_HEIGHT - 80, LOAD_ASSETS.KEY.PLAY)
        .setInteractive()
        .setScrollFactor(0)
        .setAlpha(0.8)
        .setScale(0.1)
